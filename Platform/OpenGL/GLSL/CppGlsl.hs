...
#include "saturate.glsl"
	...
	#define uint4 uvec4
	#define frac fract
	#define texture_clamp(tex,texc) texture(tex,vec2((texc).x,1.0-(texc).y))
	#define texture_wrap(tex,texc) texture(tex,vec2((texc).x,1.0-(texc).y))
	#define texture_clamp_mirror(tex,texc) texture(tex,vec2((texc).x,1.0-(texc).y))
	#define texture_wrap_clamp(tex,texc) texture(tex,vec2((texc).x,1.0-(texc).y))
	#define texture_wrap_mirror(tex,texc) texture(tex,vec2((texc).x,1.0-(texc).y)) 
	#define texture_wrap_mirror_lod(tex,texc,lod) textureLod(tex,vec2((texc).x,1.0-(texc).y),lod)
	#define sample(tex,smplr,texc) texture(tex,vec2((texc).x,1.0-(texc).y))
	#define sample_lod(tex,smplr,texc,lod) textureLod(tex,vec2((texc).x,1.0-(texc).y),lod)
	#define sampleLod(tex,smplr,texc,lod) textureLod(tex,vec2((texc).x,1.0-(texc).y),lod)
	#define texture_wrap_lod(tex,texc,lod) textureLod(tex,vec2((texc).x,1.0-(texc).y),lod)
	#define texture_cwc_lod(tex,texc,lod) textureLod(tex,vec2((texc).x,1.0-(texc).y),lod)
	#define texture_clamp_lod(tex,texc,lod) textureLod(tex,vec2((texc).x,1.0-(texc).y),lod) 
	#define texture_nearest_lod(tex,texc,lod) textureLod(tex,vec2((texc).x,1.0-(texc).y),lod) 
	#define texture_clamp_mirror_lod(tex,texc,lod) textureLod(tex,vec2((texc).x,1.0-(texc).y),lod)
	#define texture_cmc_lod(tex,texc,lod) textureLod(tex,vec2((texc).x,1.0-(texc).y),lod) 
	#define texture_cmc_nearest_lod(tex,texc,lod) textureLod(tex,vec2((texc).x,1.0-(texc).y),lod)
	#define texture_wmc_lod(tex,texc,lod) textureLod(tex,vec2((texc).x,1.0-(texc).y),lod)
	#define texture_wmc(tex,texc) textureLod(tex,vec2((texc).x,1.0-(texc).y))
	...
	#define texture_nearest(tex,texc) texture(tex,vec2((texc).x,1.0-(texc).y))
	#define texture3Dpt(tex,texc) texture(tex,texc)
	#define texture2Dpt(tex,texc) texture(tex,texc)

	#define texture_clamp_mirror_nearest_lod(tex,texc,lod) textureLod(tex,vec2((texc).x,1.0-(texc).y),lod)
	...
	#define texture_3d_wwc_lod(tex,texc,lod) textureLod(tex,texc,lod)
	#define texture_3d_cwc_lod(tex,texc,lod) textureLod(tex,texc,lod) 
	#define texture_3d_cmc_lod(tex,texc,lod) textureLod(tex,texc,lod)
	#define texture_3d_cmc_nearest_lod(tex,texc,lod) textureLod(tex,texc,lod)
	#define texture_3d_wmc_lod(tex,texc,lod) textureLod(tex,texc,lod)
	#define texture_3d_wmc(tex,texc) textureLod(tex,texc,lod)
	#define sample_3d_lod(tex,sampler,texc,lod) textureLod(tex,texc,lod) 
