...
RenderTexture::RenderTexture(int w, int h, GLenum target, int samples, int coverageSamples):
    m_width(w)
	,m_height(h)
	,m_target(target)
	,m_samples(samples)
...
void RenderTexture::InitColor_RB(int index, GLenum iformat)
{
...
void RenderTexture::InitColor_Tex(int index, GLenum iformat)
{
...
void RenderTexture::InitColor_None()
{
...
void RenderTexture::InitDepth_RB(GLenum iformat)
{
    glBindFramebufferEXT(GL_FRAMEBUFFER_EXT, m_fb); 
    {
...
void RenderTexture::InitDepth_Tex(GLenum iformat)
{
...
void RenderTexture::DrawQuad(int w,int h)
{
	glBegin(GL_QUADS);
