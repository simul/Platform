...
namespace simul
{
	namespace crossplatform
	{
		...
		public:
			...
			virtual void EnsureVertexBuffer(crossplatform::RenderPlatform *renderPlatform,int num_vertices,int struct_size,const void *data,bool cpu_access=false,bool streamout_target=false)=0;
