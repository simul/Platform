...
namespace simul
{
	...
	namespace dx11
	{
		...
		public:
			...
			static void DrawQuad2(			crossplatform::DeviceContext &deviceContext,float x1,float y1,float dx,float dy,ID3DX11Effect *eff,ID3DX11EffectTechnique* tech,int pass=0);
