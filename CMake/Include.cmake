...
function(LibraryDefaults targname)
	...
	if(SIMUL_SUPPORT_D3D11)
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_D3D11=1)
	else()
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_D3D11=0)
	endif()
	if(SIMUL_SUPPORT_D3D12)
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_D3D12=1)
	else()
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_D3D12=0)
	endif()

	if(SIMUL_SUPPORT_OPENGL)
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_OPENGL=1)
	else()
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_OPENGL=0)
	endif()

	if(SIMUL_SUPPORT_VULKAN)
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_VULKAN=1)
	else()
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_VULKAN=0)
	endif()
...
function(add_static_library libname)
	cmake_parse_arguments(lib "" "RUNTIME;FOLDER" "SOURCES;DEFINITIONS;PROPERTIES;INCLUDES;PUBLICINCLUDES" ${ARGN} )
...
function(add_static_executable target)
	cmake_parse_arguments(exe "WIN32;CONSOLE" "FOLDER" "SOURCES;DEFINITIONS" ${ARGN} )
