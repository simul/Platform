...
if(PLATFORM_WINDOWS)
	...
	# set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "${CMAKE_SHARED_LINKER_FLAGS_RELEASE} /DEBUG") this seems not to work for exes. Instead use target_link_options( ${targname} PRIVATE /DEBUG ) below
...
function(add_dll libname)
	...
	if(PLATFORM_WINDOWS)
		set_target_runtime(${target} dynamic)
		set(dll_LINK_DIRS ${dll_LINK_DIRS} "${SIMUL_PLATFORM_DIR}/External/fmt/build_md/lib/$<$<CONFIG:Debug>:Debug>$<$<CONFIG:Release>:Release>")
	endif()
	if(XBOXONE)
		set_target_runtime(${target} dynamic)
