...
function(LibraryDefaults targname)
	...
	if(PLATFORM_SUPPORT_D3D11)
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_D3D11=1 SIMUL_SUPPORT_D3D11=1)
	else()
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_D3D11=0 SIMUL_SUPPORT_D3D11=0)
	endif()
	if(PLATFORM_SUPPORT_D3D12)
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_D3D12=1 SIMUL_SUPPORT_D3D12=1)
	else()
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_D3D12=0 SIMUL_SUPPORT_D3D12=0)
	endif()

	if(PLATFORM_SUPPORT_OPENGL)
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_OPENGL=1 SIMUL_SUPPORT_OPENGL=1)
	else()
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_OPENGL=0 SIMUL_SUPPORT_OPENGL=0)
	endif()

	if(PLATFORM_SUPPORT_VULKAN)
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_VULKAN=1 SIMUL_SUPPORT_VULKAN=1) 
	else()
		target_compile_definitions(${targname} PRIVATE SIMUL_USE_VULKAN=0 SIMUL_SUPPORT_VULKAN=0)
	endif()
