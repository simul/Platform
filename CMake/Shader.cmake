...
function ( add_sfx_shader_project targetName configJsonFile )
	if(SIMUL_BUILD_SHADERS)
		cmake_parse_arguments(sfx "" "INTERMEDIATE;OUTPUT" "INCLUDES;SOURCES;OPTIONS" ${ARGN} )
		set(EXTRA_OPTS)
		...
		if(NOT "${EXTRA_OPTS_S}" STREQUAL "")
			string(REPLACE "\"" "" EXTRA_OPTS_S ${EXTRA_OPTS_S})
		endif()
		...
		foreach(in_f ${sfx_SOURCES})
			...
			if(NOT ${pos} EQUAL -1)
					#message( STATUS "${SIMUL_SFX_EXECUTABLE} ${in_f} -I\"${sfx_INCLUDES}\" -O\"${out_folder}\" -P\"${configJsonFile}\" -M\"${intermediate_folder}\" ${EXTRA_OPTS_S}" )
		...
		#message("add_sfx_shader_project ${targetName} ${EXTRA_OPTS_S}")
