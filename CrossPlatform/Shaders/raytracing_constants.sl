...
#include "named_constant_buffer_helper.sl"
...
PLATFORM_NAMED_CONSTANT_BUFFER(TraceRayParameters, traceRayParameters, 2, 3)
...
PLATFORM_NAMED_CONSTANT_BUFFER_HELPER(TraceRayParameters, traceRayParameters, 2, 3)
