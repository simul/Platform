...
struct tmatrix4
{
	...
	tmatrix4<T> operator*(const tmatrix4<T> &input) const
	{
		...
		tmatrix4<T> output = {output_i.x, output_i.y, output_i.z, output_i.w, output_j.x, output_j.y, output_j.z, output_j.w, output_k.x, output_k.y, output_k.z, output_k.w, output_l.x, output_l.y, output_l.z, output_l.w};
		output.transpose();
		return output;
	}
