...
RenderDelegator::RenderDelegator(crossplatform::RenderPlatform* r)
	: last_view_id(0), renderPlatform(r)
{
}
...
void RenderDelegator::Render(int view_id, CommandContext** ppContexts, size_t numContexts, void* rendertarget, int w, int h, long long frame)
{
	ERRNO_BREAK
	...
	{
		deviceContext.commandContexts[CommandContextType(i)] = ppContexts[i];
	}
