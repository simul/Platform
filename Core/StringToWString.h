...
namespace simul
{
	namespace base
	{
		...
		extern PLATFORM_CORE_EXPORT const std::wstring &StringToWString(const std::string &text);
		extern PLATFORM_CORE_EXPORT const std::string &WStringToString(const std::wstring &text);
