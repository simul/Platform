...
namespace platform
{
	...
	{
		ResourceBindingLimits() : BindingTier(D3D12_RESOURCE_BINDING_TIER_1),
	...
	namespace dx12
	{
		...
		public:
			...
			void CreateResource(const D3D12_RESOURCE_DESC &resourceDesc, D3D12_RESOURCE_STATES state, D3D12_CLEAR_VALUE *clear, D3D12_HEAP_TYPE type, ID3D12Resource **resource, AllocationInfo &allocationInfo, const char *name);
