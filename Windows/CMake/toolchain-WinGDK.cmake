...
#message(STATUS "[HKEY_LOCAL_MACHINE\\SOFTWARE\\Wow6432Node\\Microsoft\\GDK\\${REQUIRED_GDK_TOOLCHAIN_VERSION}\\GRDK\\;EditionVersion]")
get_filename_component(GDK_TOOLCHAIN_VERSION "[HKEY_LOCAL_MACHINE\\SOFTWARE\\Wow6432Node\\Microsoft\\GDK\\${REQUIRED_GDK_TOOLCHAIN_VERSION}\\GRDK\\;EditionVersion]" NAME)
...
if( GDK_TOOLCHAIN_VERSION STREQUAL REQUIRED_GDK_TOOLCHAIN_VERSION )
	...
	get_filename_component(GDK_TOOLCHAIN_VERSION "[HKEY_LOCAL_MACHINE\\SOFTWARE\\Wow6432Node\\Microsoft\\GDK;GRDKLatest]" NAME)
...
#message(STATUS "get_filename_component(GDK_TOOLS_CL ${GDK_TOOLS_CL} DIRECTORY)")
get_filename_component(GDK_TOOLS_DIR "${GDK_TOOLS_CL}" DIRECTORY)
message(STATUS "GDK_TOOLS_DIR ${GDK_TOOLS_DIR}")
